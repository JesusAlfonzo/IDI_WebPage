...
const $$Espirometria = createComponent(($$result, $$props, $$slots) => {
  const serviceData = {
    title: "Espirometr\xEDa con o sin Broncodilatador",
    description: "Prueba de funci\xF3n pulmonar que mide la cantidad y velocidad del aire que puedes inhalar y exhalar, crucial para el diagn\xF3stico de Asma y EPOC.",
    prerequisites: [
      "Orden m\xE9dica original (vigencia no mayor a 30 d\xEDas).",
      "C\xE9dula de identidad laminada.",
      "No fumar 1 hora antes de la prueba.",
      "Suspender broncodilatadores (seg\xFAn indicaci\xF3n m\xE9dica, t\xEDpicamente 4-12 horas antes)."
    ],
    stepByStep: [
      "Registro: Presenta tu orden y documentos en la taquilla.",
      "Instrucci\xF3n: El t\xE9cnico te explicar\xE1 c\xF3mo realizar las maniobras de respiraci\xF3n forzada.",
      "Prueba Inicial: Se realizan mediciones basales.",
      "Prueba Post-Broncodilatador (si aplica): Se administra un medicamento y se repiten las mediciones.",
      "Retiro de Resultados: Los resultados estar\xE1n disponibles en la fecha indicada."
    ],
    schedule: [
      { day: "Lunes a Viernes", time: "7:00 AM - 12:00 PM" },
      { day: "Realizaci\xF3n de Pruebas", time: "7:00 AM - 10:00 AM" },
...
}, "C:/Users/Jesus.Alfonzo/Documents/work/IDI_WebPage/src/pages/espirometria.astro", void 0);

const $$file = "C:/Users/Jesus.Alfonzo/Documents/work/IDI_WebPage/src/pages/espirometria.astro";
const $$url = "/espirometria";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
    __proto__: null,
    default: $$Espirometria,
    file: $$file,
    url: $$url
