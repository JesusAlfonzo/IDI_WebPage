...
const $$PruebaEpicutanea = createComponent(($$result, $$props, $$slots) => {
  const serviceData = {
    title: "Prueba Epicut\xE1nea (Patch Test)",
    description: "Detecci\xF3n de **alergias de contacto** (Dermatitis de Contacto) a sustancias como metales, tintes o qu\xEDmicos mediante la colocaci\xF3n de parches en la espalda.",
    prerequisites: [
      "Orden m\xE9dica original.",
      "C\xE9dula de identidad laminada.",
      "Suspender corticoides orales/t\xF3picos en la zona de prueba (seg\xFAn indicaci\xF3n).",
      "Evitar la exposici\xF3n solar intensa en la espalda 1 semana antes."
    ],
    stepByStep: [
      "D\xEDa 1: Aplicaci\xF3n de parches con al\xE9rgenos en la espalda.",
      "D\xEDa 3 (48h): Primera lectura de la reacci\xF3n. Los parches son retirados.",
      "D\xEDa 5 (96h): Lectura final y diagn\xF3stico. Debes volver al centro para ambas lecturas."
    ],
    schedule: [
      { day: "Lunes a Viernes", time: "7:00 AM - 12:00 PM" },
      { day: "D\xEDa 1: Aplicaci\xF3n", time: "7:00 AM - 9:00 AM" },
      { day: "D\xEDas 3 y 5: Lectura", time: "9:00 AM - 11:00 AM" }
    ],
    contactInfo: {
...
}, "C:/Users/Jesus.Alfonzo/Documents/work/IDI_WebPage/src/pages/prueba-epicutanea.astro", void 0);

const $$file = "C:/Users/Jesus.Alfonzo/Documents/work/IDI_WebPage/src/pages/prueba-epicutanea.astro";
const $$url = "/prueba-epicutanea";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
    __proto__: null,
    default: $$PruebaEpicutanea,
    file: $$file,
    url: $$url
