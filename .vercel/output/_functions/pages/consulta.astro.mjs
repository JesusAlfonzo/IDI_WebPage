...
const $$Consulta = createComponent(($$result, $$props, $$slots) => {
  const serviceData = {
    title: "Consulta Especializada en Inmunolog\xEDa",
    description: "Evaluaci\xF3n m\xE9dica integral con nuestros especialistas para el diagn\xF3stico y manejo de enfermedades inmunol\xF3gicas, autoinmunes y al\xE9rgicas.",
    prerequisites: [
      "C\xE9dula de identidad laminada.",
      "Informes y ex\xE1menes de laboratorio previos.",
      "Lista de medicamentos actuales (dosis y frecuencia)."
    ],
    stepByStep: [
      "Registro: Presenta tu documentaci\xF3n en la taquilla.",
      "Espera: Ser\xE1s llamado por el personal m\xE9dico.",
      "Consulta: Entrevista y examen f\xEDsico por el m\xE9dico especialista.",
      "Indicaciones y Plan: El m\xE9dico te proporcionar\xE1 un diagn\xF3stico, indicaciones y/o una orden para ex\xE1menes."
    ],
    schedule: [
      { day: "Lunes a Viernes", time: "Horario de Citas" },
      { day: "Recepci\xF3n de pacientes", time: "8:00 AM - 12:00 PM" },
      { day: "Emergencias/Prioridad", time: "Seg\xFAn disponibilidad" }
    ],
    contactInfo: {
...
}, "C:/Users/Jesus.Alfonzo/Documents/work/IDI_WebPage/src/pages/consulta.astro", void 0);

const $$file = "C:/Users/Jesus.Alfonzo/Documents/work/IDI_WebPage/src/pages/consulta.astro";
const $$url = "/consulta";
