...
const $$TratamientoParenteral = createComponent(($$result, $$props, $$slots) => {
  const serviceData = {
    title: "Administraci\xF3n de Tratamiento Parenteral",
    description: "Servicio de administraci\xF3n supervisada de medicamentos e inmunoglobulinas por v\xEDa intravenosa o intramuscular, bajo indicaci\xF3n m\xE9dica.",
    prerequisites: [
      "Orden m\xE9dica original que especifique dosis y v\xEDa de administraci\xF3n.",
      "C\xE9dula de identidad laminada.",
      "Medicamento/Inmunoglobulina a administrar (debe ser suministrada por el paciente)."
    ],
    stepByStep: [
      "Recepci\xF3n y Verificaci\xF3n: Se revisa la orden, el medicamento y los signos vitales del paciente.",
      "Preparaci\xF3n: El personal de enfermer\xEDa prepara la dosis para su administraci\xF3n.",
      "Administraci\xF3n: El medicamento es aplicado por v\xEDa intravenosa (IV) o intramuscular (IM).",
      "Observaci\xF3n: El paciente permanece bajo vigilancia durante un per\xEDodo tras la administraci\xF3n."
    ],
    schedule: [
      { day: "Lunes a Viernes", time: "7:00 AM - 12:00 PM" },
      { day: "Horario de Aplicaci\xF3n", time: "7:00 AM - 11:00 AM" }
    ],
    contactInfo: {
...
}, "C:/Users/Jesus.Alfonzo/Documents/work/IDI_WebPage/src/pages/tratamiento-parenteral.astro", void 0);

const $$file = "C:/Users/Jesus.Alfonzo/Documents/work/IDI_WebPage/src/pages/tratamiento-parenteral.astro";
const $$url = "/tratamiento-parenteral";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
    __proto__: null,
    default: $$TratamientoParenteral,
    file: $$file,
    url: $$url
